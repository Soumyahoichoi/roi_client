...
export default function CardOne({title, description, discountedPrice ,sendData,counterData}) {
  ...
  return (
                <div class="w-full mx-auto bg-white shadow-md rounded-lg overflow-hidden my-2 flex">
                  ...
                  <div class="flex space-x-4 py-8">
                    <button class="bg-gray-300 shadow-md hover:bg-gray-500 hover:shadow-lg text-black text-4xl font-normal  rounded-full w-12 h-12 disabled:opacity-50"
                    onClick={handleIncrement}
                    disabled={counter === 1}
                    >
                      +
                    </button>
                    <p class="text-gray-500 text-2xl px-4 py-12">{counter}</p>
                    <button class="bg-gray-300  shadow-md hover:bg-gray-500 hover:shadow-lg text-black text-4xl font-normal  rounded-full  w-12 h-12 disabled:opacity-50"
...
export function CardTwo({title, description, subTitle, discountedPrice,sendData }) {
  const [counter, setCounter] = useState(0);
