    ...
    <div>
      <form method="POST" name="customerData" action="/ccavRequestHandler">
		...
		<table width="40%" height="100" border='1' align="center">
			...
			<tr>
				<td>Merchant Id</td>
				<td><input type="text" name="merchant_id" id="merchant_id" value="2566790" /> </td>
			</tr>
			<tr>
				<td>Order Id</td>
			...
			<tr>
				...
				<td><input type="text" name="redirect_url"
					value="http://127.0.0.1:3001/api/successed" />
				</td>
			</tr>
			<tr>
				<td>Cancel URL</td>
				<td><input type="text" name="cancel_url"
					value="http://127.0.0.1:3001/api/failed" />
				</td>
			</tr>
			<tr>
				<td>Language</td>
			...
			<tr>
				<td></td>
				<td><button type="submit" value="Checkout"/></td>
			</tr>
		</table>
	    </form>
    </div>
